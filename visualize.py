...
print("singel test loss ",test_loss[0].shape)
...
ax.set_ylabel("test_error")
ax.set_xlabel("epochs")
ax.scatter(benford_epochs_single_seed, 100- test_acc_benford_single_seed[benford_epochs_single_seed], marker="v", label="benford iterations")
